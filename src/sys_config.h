...
#define MAX_TRANSLATE_BLOCK_SIZE_I0_MOD_TRAN	(0x40000ULL)
#define MIN_TRANSLATE_BLOCK_SIZE_I0_MOD_TRAN	(0x10000ULL)
#define MAX_TRANSLATE_OVER_LOOK_CODE_SIZE		(0x200ULL)
